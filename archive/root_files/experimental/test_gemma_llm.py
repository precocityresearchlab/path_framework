...
Keep your response concise and structured.""",
        ...
        print("   Cost: Free (Gemma 3 27B is free on OpenRouter)")
        print("   Response Generated: ✅ Success")
        ...
        analysis_request = LLMRequest(
            prompt=requirements_prompt, temperature=0.2, max_tokens=400
        )
        ...
        try:
            ...
            for req in parsed.get("requirements", []):
                print(
                    f"   • {req.get('title', 'Unknown')}: {req.get('priority', 'unknown')} priority"
                )
        ...
        print("   • Gemma 3 27B model execution")
        print("   • Basic conversation capabilities")
        print("   • Structured prompt processing")
        print("   • Response metadata extraction")
