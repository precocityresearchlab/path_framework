...
async def demo_configuration_methods():
    ...
    env_vars = [
        "PATH_LLM_PROVIDER", "PATH_LLM_MODEL", 
    ...
    try:
        ...
        print(f"   ✅ Created agent with custom config")
...
async def demo_configuration_priority():
    ...
    try:
        ...
        print("   📝 Function params: provider=openrouter, model=anthropic/claude-3-sonnet")
        ...
        if response.provider == "openrouter" and "claude" in response.model_used.lower():
