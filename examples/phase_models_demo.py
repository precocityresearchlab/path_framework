...
async def demo_phase_specific_models():
    ...
    if not os.getenv("OPENROUTER_API_KEY"):
        ...
        print(f"export OPENROUTER_API_KEY='your-api-key'")
        print(f"export PATH_LLM_PROVIDER='openrouter'")
        print(f"export PATH_LLM_MODEL_PHASE1='openai/gpt-4'           # Best for analysis")
        print(f"export PATH_LLM_MODEL_PHASE2='anthropic/claude-3-sonnet'  # Good for planning")
        print(f"export PATH_LLM_MODEL_PHASE3='meta-llama/llama-2-70b-chat'  # Fast for coding")
        print(f"export PATH_LLM_MODEL_PHASE4='openai/gpt-3.5-turbo'  # Efficient for testing")
        return
...
async def demo_model_comparison():
    ...
    test_prompt = "List 3 benefits of microservices architecture in exactly 3 bullet points"
...
async def demo_configuration_priority():
    ...
    if phase1_model:
        ...
        print(f"      Phase 1 should use: Default model")
