...
from path_framework.models.arch_models import SystemArchitecture, TechnologyStack
...
class ArchitectureTools:
    ...
    def _load_architecture_patterns(self) -> Dict[str, ArchitecturePattern]:
        ...
        patterns = {
            "layered": ArchitecturePattern(
                ...
                technology_requirements=["Framework supporting layered architecture", "ORM", "DI container"]
            ),
            ...
            "hexagonal": ArchitecturePattern(
                ...
                technology_requirements=["Dependency injection", "Interface/contract support", "Mocking frameworks"]
            ),
            ...
            "microservices": ArchitecturePattern(
                ...
                technology_requirements=["Container platform", "API gateway", "Service mesh", "Monitoring tools"]
            )
        }
        ...
        return {
            "backend": [
                TechnologyAssessment(
                    ...
                    score=8.5,
                    pros=["Fast development", "Excellent async support", "Great documentation", "Type hints"],
                    cons=["Performance limitations", "GIL for CPU tasks"],
                    compatibility={"frontend": "excellent", "database": "excellent", "cloud": "excellent"},
                ...
                TechnologyAssessment(
                    ...
                    category=TechnologyCategory.BACKEND,
                    score=8.0,
                    pros=["JavaScript everywhere", "Large ecosystem", "Good performance", "Event-driven"],
                    cons=["Callback complexity", "Single-threaded", "Rapid ecosystem changes"],
                    compatibility={"frontend": "excellent", "database": "good", "cloud": "excellent"},
                    learning_curve="medium",
                    community_support="excellent",
                    maturity="stable"
                ),
                TechnologyAssessment(
                    ...
                    category=TechnologyCategory.BACKEND,
                    score=8.8,
                    pros=["Enterprise ready", "Excellent tooling", "Strong typing", "Performance"],
                    cons=["Verbose syntax", "Memory usage", "Slow startup"],
                    compatibility={"frontend": "good", "database": "excellent", "cloud": "excellent"},
                    learning_curve="high",
                    community_support="excellent",
                    maturity="mature"
                )
            ...
            "frontend": [
                TechnologyAssessment(
                    ...
                    score=9.0,
                    pros=["Large ecosystem", "Component reusability", "Virtual DOM", "Strong community"],
                    cons=["Learning curve", "Rapid changes", "JSX complexity"],
                    compatibility={"backend": "excellent", "mobile": "good", "desktop": "good"},
                    learning_curve="medium",
                    community_support="excellent",
                    maturity="stable"
                ),
                TechnologyAssessment(
                    ...
                    category=TechnologyCategory.FRONTEND,
                    score=8.5,
                    pros=["Easy learning curve", "Good documentation", "Template syntax", "Progressive adoption"],
                    cons=["Smaller ecosystem", "Less job market", "Single maintainer risk"],
                    compatibility={"backend": "excellent", "mobile": "fair", "desktop": "fair"},
                    learning_curve="low",
            ...
            "database": [
                TechnologyAssessment(
                    ...
                    compatibility={"backend": "excellent", "cloud": "excellent", "scaling": "good"},
                    learning_curve="medium",
                    community_support="excellent",
                    maturity="mature"
                ),
                TechnologyAssessment(
                    ...
                    category=TechnologyCategory.DATABASE,
                    score=7.8,
                    pros=["Flexible schema", "Horizontal scaling", "JSON documents", "Fast development"],
                    cons=["Data consistency", "Memory usage", "Learning curve for SQL developers"],
                    compatibility={"backend": "excellent", "cloud": "excellent", "scaling": "excellent"},
                    learning_curve="medium",
                    community_support="excellent",
                    maturity="stable"
                )
    ...
    def recommend_patterns(self, requirements: Dict[str, Any]) -> List[ArchitecturePattern]:
    ...
    def assess_technology_stack(self, requirements: Dict[str, Any]) -> Dict[str, List[TechnologyAssessment]]:
    ...
    def _calculate_compatibility_score(self, tech: TechnologyAssessment, requirements: Dict[str, Any]) -> float:
        """Calculate compatibility score based on requirements"""
        base_score = tech.score
        
        # Adjust based on requirements
        if requirements.get("performance", "medium") == "high" and "performance" in tech.pros:
            base_score += 0.5
        
        if requirements.get("team_experience", "medium") == "low" and tech.learning_curve == "low":
            base_score += 0.3
    ...
    def generate_architecture_diagram_config(self, architecture: SystemArchitecture) -> Dict[str, Any]:
    ...
    def _load_design_patterns(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "singleton": {
                ...
                "use_cases": ["Configuration management", "Logging", "Database connections"],
                "implementation": {
                    "python": """
class Singleton:
    _instance = None
    ...
    constructor() {
        ...
        Singleton.instance = this;
            ...
            "factory": {
                ...
                "use_cases": ["Object creation abstraction", "Plugin systems", "Framework development"],
                "implementation": {
                    "python": """
class ShapeFactory:
    @staticmethod
    def create_shape(shape_type):
        ...
        raise ValueError(f"Unknown shape: {shape_type}")
            ...
            "observer": {
                ...
                "use_cases": ["Event systems", "Model-View architectures", "Reactive programming"],
                "implementation": {
                    "python": """
class Subject:
    def __init__(self):
    ...
    def notify(self, message):
        for observer in self._observers:
            observer.update(message)
                ...
                "cons": ["Memory leaks risk", "Order dependencies", "Performance impact"]
            },
            
            "strategy": {
                "category": "behavioral", 
                "intent": "Define family of algorithms and make them interchangeable",
                "use_cases": ["Payment processing", "Sorting algorithms", "Validation rules"],
                "implementation": {
                    "python": """
...
class PayPalPayment(PaymentStrategy):
    def pay(self, amount):
        return f"Paid ${amount} with PayPal"
                ...
                "pros": ["Runtime algorithm selection", "Code reuse", "Open/closed principle"],
    ...
    def recommend_patterns(self, problem_description: str) -> List[Dict[str, Any]]:
        ...
        if "creation" in keywords or "factory" in keywords or "instantiation" in keywords:
...
class ModelingFrameworks:
    ...
    def generate_domain_model(self, domain_entities: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def generate_c4_model(self, system_architecture: SystemArchitecture) -> Dict[str, Any]:
            ...
            "level2_containers": [
                {
                    "name": comp.name,
                    "type": comp.component_type,
                    "technology": comp.technologies[0] if comp.technologies else "Unknown",
