...
async def generate_architecture_with_llm():
    ...
    try:
        ...
        try:
            ...
            print(f"🎯 Successfully parsed {len(requirements_data.get('requirements', []))} requirements")
        except json.JSONDecodeError:
            print("⚠️  Requirements response not in valid JSON, but that's okay")
            requirements_data = {"requirements": [], "business_rules": [], "stakeholders": []}
        ...
        try:
            ...
            print(f"🏗️ Successfully parsed architecture with {len(architecture_data.get('components', []))} components")
        except json.JSONDecodeError:
        ...
        with open(output_dir / "requirements_analysis.txt", "w") as f:
            f.write(f"# Requirements Analysis - Generated by Gemma 3 27B\n\n")
        ...
        with open(output_dir / "system_architecture.txt", "w") as f:
            f.write(f"# System Architecture - Generated by Gemma 3 27B\n\n")
            f.write(f"Project: {project_name}\n")
        ...
        with open(output_dir / "api_design.txt", "w") as f:
            f.write(f"# API Design - Generated by Gemma 3 27B\n\n")
            f.write(f"Project: {project_name}\n")
        ...
        # Summary
        total_tokens = req_response.tokens_used + arch_response.tokens_used + api_response.tokens_used
        ...
        print(f"💰 Total cost: FREE (Gemma 3 27B)")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("Check the generated artifacts in projects/Helpdesk API/llm_generated_architecture/")
    else:
